...
import { UserRole } from "./user_role_type";
// Mark import as potentially unused
declare type __keep_UserRole = UserRole;
  ...
  getTypeScriptAlgebraicType(): __AlgebraicTypeType {
    return __AlgebraicTypeValue.Product({
      elements: [
        ...
        { name: "role", algebraicType: UserRole.getTypeScriptAlgebraicType()},
        { name: "outletId", algebraicType: __AlgebraicTypeValue.createOptionType(__AlgebraicTypeValue.U64)},
      ]
    });
  },
